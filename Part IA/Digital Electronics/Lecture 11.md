#### Potential dividers
$V_{2}=V\left( \frac{R_{2}}{R_{1}+R_{2}} \right)$
...
Metal tracks used on circuit boards have finite capacitance to ground. This increases the rise time of the output signal.

#### CMOS logic
Uses both n-channel and p-channel MOSFETs
![[CMOSInverter.png]]
Only one transistor is on at a time. Power is only dissipated when they are switching.