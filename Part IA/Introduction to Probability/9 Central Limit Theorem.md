...
$$Z_{n}:=\sqrt{ n }\cdot \frac{\overline{X}_{n}-\mu}{\sigma}= \frac{\sum^n_{i=1}X_{i}-n\mu} {\sqrt{ n }\sigma}$$
...
Split into n Bernoulli trials, transform with above transformation. Then lookup in standard normal table.